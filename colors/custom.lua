...
vim.api.nvim_set_hl(0, "CmpDocumentation", { bg = "#2b3b51", fg = "#cdcecf" })
vim.api.nvim_set_hl(0, "CmpDocumentationBorder", { fg = "#2b3b51" })
...
vim.api.nvim_set_hl(0, "DiagnosticVirtualTextError", { bg = "NONE", fg = "#c94f6d" })
vim.api.nvim_set_hl(0, "DiagnosticVirtualTextHint", { bg = "NONE", fg = "#81b29a" })
vim.api.nvim_set_hl(0, "DiagnosticVirtualTextInfo", { bg = "NONE", fg = "#719cd6" })
vim.api.nvim_set_hl(0, "DiagnosticVirtualTextWarn", { bg = "NONE", fg = "#dbc074" })
...
vim.api.nvim_set_hl(0, "GlyphPalette10", { fg = "#8db9a4" })
vim.api.nvim_set_hl(0, "GlyphPalette11", { fg = "#e0c988" })
...
vim.api.nvim_set_hl(0, "GlyphPalette8", { fg = "#565860" })
vim.api.nvim_set_hl(0, "GlyphPalette9", { fg = "#d16982" })
...
vim.api.nvim_set_hl(0, "Keyword", { fg = "#50bee2" })
...
vim.api.nvim_set_hl(0, "NeoTreeNormal", { bg = "NONE", fg = "#cdcecf" })
...
vim.api.nvim_set_hl(0, "Normal", { bg = "NONE", fg = "#cdcecf" })
vim.api.nvim_set_hl(0, "NormalFloat", { bg = "#131a24", fg = "#cdcecf" })
vim.api.nvim_set_hl(0, "NormalNC", { bg = "NONE", fg = "#cdcecf" })
...
vim.api.nvim_set_hl(0, "NvimTreeNormal", { bg = "NONE", fg = "#cdcecf" })
...
vim.api.nvim_set_hl(0, "TSFuncBuiltin", { fg = "#9d79d6" })
...
vim.api.nvim_set_hl(0, "TSStringEscape", { bold = true, fg = "#e0c988" })
vim.api.nvim_set_hl(0, "TSStringRegex", { fg = "#e0c988" })
...
vim.api.nvim_set_hl(0, "WhichKey", { bold = true, fg = "#9d79d6" })
vim.api.nvim_set_hl(0, "WhichKeyDesc", { fg = "#209cc5" })
vim.api.nvim_set_hl(0, "WhichKeyFloat", { bg = "#131a24" })
vim.api.nvim_set_hl(0, "WhichKeyGroup", { bold = true, fg = "#3ab6df" })
...
vim.api.nvim_set_hl(0, "WinBar", { bg = "NONE", bold = true, fg = "#71839b" })
vim.api.nvim_set_hl(0, "WinBarNC", { bg = "NONE", bold = true, fg = "#71839b" })
